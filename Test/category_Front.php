...
<html>
  <head>
   ...
   <body>
      ...
      <div class='two'>
         <p>
         <input class='input-one' type='button' id='ins' value='Insert' onclick='myClick(this,"category")'></input>
         </p>
         <p>
         <input class='input-one' type='button' id='apd' value='Update' onclick='myClick(this,"category")'></input>
         </p>
         <p>
         <input class='input-one' type='button' id='del' value='Delete' onclick='myClick(this,"category")'></input>
         </p>
      </div>
   ...
   <tr>
      ...
      <?php
         ...
         $rsRows = $Newcategory->executeSQL_category('select id,name from category where 1=1');
         $z=0;
